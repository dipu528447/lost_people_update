                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 ml-6 p-2 shadow bg-base-100 rounded-box w-52">
                            <Link to="/userDashboard"><li><label>Home</label></li></Link>
                            <Link to="userDashboard/postManagement"><li><label>Post Management</label></li></Link>
                            {user.email==="admin@admin.com"?<Link to="userDashboard/userManagement"><li><label>User Management</label></li></Link>:""}
                            {user.id && <Link to="userDashboard/profile"><li><label>Profile</label></li></Link>}
